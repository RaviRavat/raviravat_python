...
'''
l1=[1,1.1,'savan',101,True,55,False]
l1.reverse()
print(l1)
...
l2=[1,1.1,'savan',101,True,55,False]
l2.pop()
print(l2)
...
l4=[1,1.1,'Ravi',101,True,55,False]
l4.append(77)
print(l4)
...
l8=[2,3,5,2,3,8,7,4,9,10,'savan']
print(list(set(l8)))

#or

l8_1=[2,3,5,2,3,8,7,4,9,10,'savan']
c=[]
for i in l8_1:
    if i not in c:
        c.append(i)
...
l12=[2,3,5,2,3,8,7,4,9,10,'savan']
c=[]
for i in l12:
    if i not in c:
        c.append(i)
...
l14=['Ravi',1,'Ravat','Karan',55,44,88,99,100]
...
l14=['Ravi',1,'Ravat','Mehul',55,44,88,99,100]
...
l18= [(1,2,1.1,True,5,6,),('Ravat',5.5,7,3,1.1,False,),(5.5,786,'Ravi',22)]
print(l18)
var1,var2,var3=l18
print('Var1 -:',var1)
print('Var2 -:',var2)    
...
l27=[(11,55,'sk'),('sk',5,8,66),(88,55,33)]
print(l27)
